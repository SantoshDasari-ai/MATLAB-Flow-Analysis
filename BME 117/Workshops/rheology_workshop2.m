...
fprintf('The fluid with the highest shear stress at 1.5 s^-1 is Data Set %d with %.4f Pa\n', max_index, max_stress);

%% Step 10: Analyze viscosity curves
fprintf('\nViscosity Curve Analysis:\n');
fprintf('Data Set 1: '); % Add your comment here based on the viscosity curve
fprintf('Data Set 2: '); % Add your comment here based on the viscosity curve
fprintf('Data Set 3: '); % Add your comment here based on the viscosity curve
fprintf('Data Set 4: '); % Add your comment here based on the viscosity curve